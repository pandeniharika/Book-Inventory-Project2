...
exports.create = (req, res) => {
    ...
    Mybook.create(mybook)
        ...
        .catch(err => {
            res.status(500).send({
                message:
                    err.message || "Some error occured while creating the Mybook."
            });
        });

    // Retrieve all Mybooks from the db
    exports.findAll = (req, res) => {
        ...
        Mybook.findAll({ where: condition })
            ...
            .catch(err => {
                res.status(500).send({
                    message:
                        err.message || "Some error occured while retrieving the Mybook."
                });
            });
    };
    ...
    //Update a Mybook by the id in request
    ...
    //Delete a Mybook with the specified id
    ...
    //Find all Mybooks with published = true:
